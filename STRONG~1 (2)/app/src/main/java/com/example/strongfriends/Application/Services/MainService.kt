...
class MainService :Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        startForeground(1,NotificationFactory.create(this,"강한친구육군","메인서비스", com.example.strongfriends.R.mipmap.ic_launcher))
        var timer= Timer()
    ...
    fun setOption(option:Periodic_response){
        ...
        Option.timer="2019052813000020190623022600"
